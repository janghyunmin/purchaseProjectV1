...
import run.piece.dev.databinding.FragmentHistoryWithdrawBinding
...
// 회원 거래 내역 출금 화면
@AndroidEntryPoint
class HistoryWithDrawFragment : BaseFragment<FragmentHistoryWithdrawBinding>(FragmentHistoryWithdrawBinding::inflate) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            fragment = this@HistoryWithDrawFragment
            viewModel = viewModel
    ...
    private fun loadMore(rvAdapter: DepositHistoryRvAdapter) {
        ...
        moreJob = viewModel.viewModelScope.launch {
            launch(Dispatchers.IO) {
                this@HistoryWithDrawFragment.viewModel.getHistory("v0.0.2","WITHDRAW", page = page)
            }
    ...
    companion object {
        fun newInstance(title: String, data: List<HistoryItemVo>, vranNo: String): HistoryWithDrawFragment {
            var fragment = HistoryWithDrawFragment()
