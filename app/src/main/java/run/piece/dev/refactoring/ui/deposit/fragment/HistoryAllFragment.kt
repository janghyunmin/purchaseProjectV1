...
import run.piece.dev.databinding.FragmentHistoryAllBinding
...
// 전체 거래 내역 조회 화면
@AndroidEntryPoint
class HistoryAllFragment : BaseFragment<FragmentHistoryAllBinding>(FragmentHistoryAllBinding::inflate) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            fragment = this@HistoryAllFragment
            viewModel = viewModel
    ...
    private fun loadMore(rvAdapter: DepositHistoryRvAdapter) {
        ...
        moreJob = viewModel.viewModelScope.launch {
            launch(Dispatchers.IO) {
                this@HistoryAllFragment.viewModel.getHistory("v0.0.2","ALL", page = page)
            }
    ...
    companion object {
        fun newInstance(title: String, data: List<HistoryItemVo>, vranNo: String): HistoryAllFragment {
            var fragment = HistoryAllFragment()
